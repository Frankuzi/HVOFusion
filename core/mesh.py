...
class Mesh:
    ...
    def edges(self):        
        if self._edges is None:
            ...
            self._edges, self._edges_mask, self._verts_mask = find_edges(self.indices, self.vertices)      
        return self._edges
    ...
    def connected_faces(self):
        if self._connected_faces is None:
            ...
            self._connected_faces = find_connected_faces(self.vertices, self.indices, self.face_normals)  
